...
def calculate_macd(closes):
    ...
    is_golden = macd_line > signal_line and histogram > 0
...
def trade_buy(ticker=None):
    ...
    # ===== 🆕 최종 매수 조건 (BB 전환점 특화) =====
    can_buy = (
        # [조건 1] 신호 강도: 65점 이상 (기존 55점에서 상향)
        selected_score >= 65 and
        ...
        # [조건 4] RSI 범위
        10 < ind['rsi_5m'] < 40 and
        
        # [조건 5] BB 위치
        ind['bb_5m_pos'] < 0.25 and
        ...
        # [조건 7] 🆕 반등 가능성 65% 이상
        (rebound and rebound['probability'] >= 0.65)
    )
