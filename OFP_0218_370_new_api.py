...
def sell_thread_worker():
    ...
    print(f"{Colors.YELLOW}[Thread 2] v19.0 매도 스레드 시작 ({SELL_THREAD_INTERVAL}초 주기){Colors.ENDC}")
    if MORNING_CLEANUP_ENABLED:
...
"""
    ...
    print(f"{Colors.YELLOW}[Thread 2] v19.0 매도 스레드 종료{Colors.ENDC}")
